...
peram_u_dir = (
    "/public/group/lqcd/perambulators/beta6.41_mu-0.2295_ms-0.2050_L32x96/light/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_L32x96_momsmear0_Liu/beta6.41_mu-0.2295_ms-0.2050_L32x96/%s/"
    % (conf_id)
)
VVV_dir = (
    "/public/group/lqcd/donghx/VVV/beta6.41_mu-0.2295_ms-0.2050_L32x96_momsmear0/%s/"
    % (conf_id)
)
...
for Pz in Pzlist:
    ...
    if rank == 0:
        ...
        for rank in range(1, size):
            comm.Recv(contrac_nucl_matrix, source=rank, tag=rank)
