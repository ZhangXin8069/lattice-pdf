...
# mom_smear = 0
# momsmear_phase = 0
eig_dir = "/public/group/lqcd/eigensystem/beta6.72_mu-0.1850_ms-0.1700_L48x144/%s/" % (
    conf_id
)
peram_u_dir = (
    "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.72_mu-0.1850_ms-0.1700_L48x144/output_dir_data/mz-2_my0_mx0/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.72_mu-0.1850_ms-0.1700_L48x144/momsmear2z/%s/"
    % (conf_id)
)


# peram_u_dir = (
#     "/public/home/sunp/sunpeng_new_disk/perambulators/beta6.72_mu-0.1850_ms-0.1700_L48x144/output_dir_data/mz0_my0_mx0/%s/"
#     % (conf_id)
# )
# corr_nucl_dir = (
#     "/public/group/lqcd/donghx/2pt_Result/beta6.72_mu-0.1850_ms-0.1700_L48x144/%s/"
#     % (conf_id)
# )
