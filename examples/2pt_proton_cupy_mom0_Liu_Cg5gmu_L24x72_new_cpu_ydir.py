...
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.20_mu-0.2770_ms-0.2400_L24x72_momsmear2y/%s/"
    % (conf_id)
)
VVV_dir = (
    "/public/group/lqcd/donghx/VVV/beta6.20_mu-0.2770_ms-0.2400_L24x72_momsmear2y/%s/"
    % (conf_id)
)
