...
peram_u_dir = (
    "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.498_mu-0.2150_ms-1926_L36x108/output_dir_data/mz-2_my0_mx0/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.498_mu-0.2150_ms-1926_L36x108/momsmear2z/%s/"
    % (conf_id)
)
