...
peram_u_dir = (
    "/public/group/lqcd/perambulators/beta6.308_mu-0.2510_ms-0.2170_u00.859727_u0s0.954467_L32x64/light/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.308_mu-0.2510_ms-0.2170_u00.859727_u0s0.954467_L32x64/%s/"
    % (conf_id)
)
VVV_dir = (
    "/public/group/lqcd/donghx/VVV/beta6.308_mu-0.2510_ms-0.2170_u00.859727_u0s0.954467_L32x64/%s/"
    % (conf_id)
)
