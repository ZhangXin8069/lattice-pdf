...
peram_u_dir = (
    "/public/home/sunp/sunpeng_2025_04_23/mom_smear_perambulators/beta6.41_mu-0.2295_ms-0.2050_L32x96/output_dir_data/mz0_my0_mx-2/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.41_mu-0.2295_ms-0.2050_L32x96_momsmear2x/%s/"
    % (conf_id)
)
VVV_dir = (
    "/public/group/lqcd/donghx/VVV/beta6.41_mu-0.2295_ms-0.2050_L32x96_momsmear2x/%s/"
    % (conf_id)
)
