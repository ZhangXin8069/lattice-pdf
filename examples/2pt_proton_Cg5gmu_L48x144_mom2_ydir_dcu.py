...
peram_u_dir = (
    "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.72_mu-0.1850_ms-0.1700_L48x144/output_dir_data/mz0_my-2_mx0/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.72_mu-0.1850_ms-0.1700_L48x144/momsmear2y/%s/"
    % (conf_id)
)
