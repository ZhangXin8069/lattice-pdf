...
peram_u_dir = (
    "/public/group/lqcd/perambulators/beta6.498_mu-0.2150_ms-1926_L36x108_sunpeng/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.498_mu-0.2150_ms-1926_L36x108/%s/"
    % (conf_id)
)
VVV_dir = (
