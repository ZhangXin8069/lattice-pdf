...
mom_smear = 0
momsmear_phase = 0
eig_dir = "/public/group/lqcd/eigensystem/beta6.20_mu-0.2825_ms-0.2310_L48x96/%s/" % (
    conf_id
)
# peram_u_dir = (
#     "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.20_mu-0.2825_ms-0.2310_L48x96/output_dir_data/mz-4_my0_mx0/%s/"
#     % (conf_id)
# )
# corr_nucl_dir = (
#     "/public/group/lqcd/donghx/2pt_Result/beta6.20_mu-0.2825_ms-0.2310_L48x96/momsmear4z/%s/"
#     % (conf_id)
# )

peram_u_dir = (
    "/public/group/lqcd/perambulators/beta6.20_mu-0.2825_ms-0.2310_L48x96/light/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.20_mu-0.2825_ms-0.2310_L48x96/momsmear0_Cg5/%s/"
    % (conf_id)
)
...
phase = np.array([momsmear_phase, 0, 0], dtype=complex)
