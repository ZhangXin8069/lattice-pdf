...
# )
# peram_u_dir = (
#     "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.20_mu-0.2825_ms-0.2310_L48x96/output_dir_data/mz0_my-2_mx0/%s/"
#     % (conf_id)
# )
# corr_nucl_dir = (
#     "/public/group/lqcd/donghx/2pt_Result/beta6.20_mu-0.2825_ms-0.2310_L48x96/momsmear2y/%s/"
#     % (conf_id)
# )
eig_dir = "/public/group/lqcd/eigensystem/beta6.20_mu-0.2825_ms-0.2310_L48x96/%s/" % (
    conf_id
...
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.20_mu-0.2825_ms-0.2310_L48x96/momsmear0/%s/"
    % (conf_id)
)
