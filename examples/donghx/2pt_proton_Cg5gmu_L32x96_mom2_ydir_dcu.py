...
peram_u_dir = (
    "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.41_mu-0.2295_ms-0.2050_L32x96/output_dir_data/mz0_my2_mx0/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.41_mu-0.2295_ms-0.2050_L32x96/momsmear-2y/%s/"
    % (conf_id)
)
