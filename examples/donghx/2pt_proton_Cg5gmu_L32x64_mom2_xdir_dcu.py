...
peram_u_dir = (
    "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.308_mu-0.2510_ms-0.2170_u00.859727_u0s0.954467_L32x64/output_dir_data/mz0_my0_mx-2/%s/"
    % (conf_id)
)
corr_nucl_dir = (
    "/public/group/lqcd/donghx/2pt_Result/beta6.308_mu-0.2510_ms-0.2170_u00.859727_u0s0.954467_L32x64/momsmear2x_new/%s/"
    % (conf_id)
)
...
# )
# peram_u_dir = (
#     "/public/home/sunp/sunpeng_new_disk/mom_smear_perambulators/beta6.20_mu-0.2790_ms-0.2400_L32x64/output_dir_data/mz0_my0_mx-2/%s/"
#     % (conf_id)
# )
# corr_nucl_dir = (
#     "/public/group/lqcd/donghx/2pt_Result/beta6.20_mu-0.2790_ms-0.2400_L32x64/momsmear2x/%s/"
#     % (conf_id)
# )
# eig_dir = "/public/group/lqcd/eigensystem/beta6.20_mu-0.2790_ms-0.2400_L32x64/%s/" % (
#     conf_id
# )
# peram_u_dir = (
#     "/public/group/lqcd/perambulators/beta6.20_mu-0.2790_ms-0.2400_L32x64/light/%s/"
#     % (conf_id)
# )
# corr_nucl_dir = (
#     "/public/group/lqcd/donghx/2pt_Result/beta6.20_mu-0.2790_ms-0.2400_L32x64/momsmear0/%s/"
#     % (conf_id)
# )
...
phase = torch.tensor([0, 0, momsmear_phase], dtype=torch.float32)
